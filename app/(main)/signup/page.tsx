...
const Signup = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!fullName || !email || !password || !confirmPassword || !agreed) {
      if (!agreed) toast.danger('You must agree to the terms');
      return
    }
        ...
        <form onSubmit={handleSubmit} className='w-full flex flex-col gap-4'>
          ...
          <div className='flex items-center gap-2.5 mt-2'>
            <button
              ...
              className={`w-4.5 h-4.5  flex shrink-0 items-center justify-center border rounded-sm transition-all cursor-pointer ${
                agreed
