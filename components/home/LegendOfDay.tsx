  ...
  return (
    <section className="w-full flex flex-col pt-3 items-center justify-center relative">
      ...
      <div className="relative group cursor-pointer">
        ...
        <div className="w-[340px] md:w-[400px]  bg-[#0A0B0FEE] backdrop-blur-xl border border-[#FFBF00] rounded-[28px] shadow-[0px_0px_10px_5px_#FFBF004D] overflow-hidden">
          
          {/* Top Player Image Container */}
          <div className="relative w-full h-[350px] overflow-hidden mb-6 border border-[#24262E66]">
            <Image
            ...
            <div className="absolute top-4 right-4 bg-[#FFB800] text-black font-black orbitron text-[15px] px-3.5 py-1.5 rounded-xl shadow-[0_4px_15px_rgba(255,184,0,0.5)] z-20">
              94.8
            </div>
          ...
          <div className="flex flex-col px-8 gap-5 pb-5">
            
            {/* Header: Name and Profession */}
            <div className="flex flex-col gap-1.5">
              <h3 className="orbitron text-[22px] md:text-[24px] font-[700] text-[#E7EBEF] tracking-tight ">
                Bob Marley
              </h3>
              <p className="outfit text-[#7B899D] text-[14px] md:text-[18px] font-[400] tracking-wide">
                Vocalist / Songwriter
              </p>
            </div>

            {/* Stats Row 1: Years and Origin */}
            <div className="flex items-center gap-6 text-[#7B899D] text-[16px] outfit font-normal">
              <div className="flex items-center gap-2">
                <FiCalendar className="text-[#00CCFF80] text-lg" aria-hidden="true" />
                <span>1960s—1980s</span>
              </div>
              <div className="flex items-center gap-2">
                <FiMapPin className="text-[#00CCFF80] text-lg" aria-hidden="true" />
                <span>Jamaica</span>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between mt-1">
              <Chip
                className="bg-[#A855F726] text-[#C084FC] border border-[#A855F733] outfit text-[14px] h-7 font-[500] uppercase tracking-[0.1em] px-4"
                variant="soft"
              >
                Music
              </Chip>
              
              <div className="flex items-center gap-2.5 text-[#7B899D] text-[16px] outfit font-[500]">
            ...
            <div className="flex flex-col gap-3 mt-2">
              <div className="flex items-center justify-between text-[14px]  tracking-[0.15em] mb-0.5">
              ...
              <div 
                className="w-full h-[12px] bg-[#1B1C22] rounded-full overflow-hidden shadow-inner"
                role="progressbar"
