      ...
      <div className="flex-1 p-4 overflow-y-auto space-y-6 custom-scrollbar">
          ...
          <div key={msg.id} className={`flex gap-3 ${msg.sender === 'user' ? 'flex-row-reverse' : ''}`}>
            ...
            <div className={`max-w-[85%] flex flex-col ${msg.sender === 'user' ? 'items-end' : ''}`}>
              <div className={`p-4 rounded-[20px] shadow-sm ${
                ...
                <p className="text-[13px] outfit leading-relaxed">
                  {msg.text}
                </p>
                {msg.chart && (
                  <AiChart 
        ...
        {isTyping && (
          <div className="flex gap-3">
            <div className="w-9 h-9 rounded-xl bg-[#1F2128] border border-[#24262E] flex items-center justify-center p-1.5 shrink-0">
               <Image src="/assets/robot.png" alt="Katy" width={24} height={24} className="animate-pulse" />
            </div>
      ...
      <div className="p-4 border-t border-[#24262E] bg-[#111217]/30">
        ...
        >
          ...
          <button 
            ...
            className="absolute right-1.5 top-1/2 -translate-y-1/2 bg-gradient-to-r from-[#00D4FF] to-[#7000FF] disabled:opacity-50 disabled:grayscale text-[#0B0F19] px-5 h-9 rounded-xl flex items-center justify-center gap-2 font-black orbitron text-[10px] uppercase tracking-[0.1em] shadow-[0_0_15px_rgba(0,212,255,0.2)] hover:shadow-[0_0_25px_rgba(0,212,255,0.4)] transition-all"
          >
            <FiSend size={12} />
            Send
          </button>
