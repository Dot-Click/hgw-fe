...
const ArticleCard = ({ id, title, description, image, category, date, readTime }: ArticleCardProps) => {
    return (
        <Link href={`/articles/${id}`} className="block h-full group">
            <Card className="bg-[#11121780] border border-[#747A94] p-0 outfit rounded-[22px] flex flex-col hover:border-[#00CCFF55] transition-all duration-300 overflow-hidden shadow-none h-full group-hover:bg-[#111217]">
